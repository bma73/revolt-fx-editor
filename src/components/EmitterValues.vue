<template>
  <div>
    ...
    <value-group label="Base">
      <value-group>
        <help
          text="Duration in seconds. 0 for one shot."
          v-show="!data.infinite"
        >
          <number-value
            :lower-limit="0"
            label="Duration"
        ...
        <help
          ...
          v-show="data.duration != 0 || data.infinite"
        >
      ...
      <value-group>
        <help text="Use gravity">
          <value-element>
            <el-checkbox border size="small" v-model="data.useGravity"
              >Use Gravity</el-checkbox
            >
          </value-element>
        </help>
    ...
    <value-group label="Emitter">
      <value-group>
        <help text="Select the emitter shape">
          <select-value
            label="Type"
            v-model="data.core.type"
            :options="emitterTypes"
          />
        </help>

        <help
          v-show="isCircleEmitter || isRingEmitter"
          text="Emitter shape radius"
        >
          <number-value
            :lower-limit="0"
            label="Radius"
            v-model="data.core.params.radius"
          />
        </help>
        ...
        <help v-show="isBoxEmitter" text="Emitter shape width">
          <number-value
            label="Width"
            :lower-limit="0"
            v-model="data.core.params.width"
          />
        </help>
        <help v-show="isBoxEmitter" text="Emitter shape height">
          <number-value
            label="Height"
            :lower-limit="0"
            v-model="data.core.params.height"
          />
        </help>

        <help
          v-show="isCircleEmitter || isRingEmitter"
          text="Emitter shape arc in degrees"
        >
        ...
        <help
          v-show="isRingEmitter"
          text="Particles are distributed uniformly on the emitter shape"
        >
          <value-element>
            <el-checkbox v-model="data.core.params.uniform"
              >Uniform</el-checkbox
            >
          </value-element>
        </help>
    ...
    <value-group label="Particle">
      <value-group>
        <help text="Particle component type">
          <select-value
            label="Type"
            v-model="data.particleSettings.componentType"
            :options="componentTypes"
          />
        </help>

        <particle-component-value
          v-model="data.particleSettings.componentId"
          :type="data.particleSettings.componentType"
        />
        {{ data.particleSettings.componentId }}
        <div v-show="data.particleSettings.componentType == 1">
          <value-element>
            <el-checkbox v-model="data.particleSettings.componentParams.loop"
              >Loop</el-checkbox
            >
          </value-element>
        ...
        <help text="Add particle on top of the display list">
          <value-element>
            <el-checkbox v-model="data.particleSettings.addOnTop"
              >Add On Top</el-checkbox
            >
          </value-element>
        </help>
      </value-group>
      ...
      <value-group>
        <help text="Enable motion settings">
          <value-element>
            <el-checkbox
              border
              size="small"
              v-model="data.particleSettings.useMotion"
              >Use Motion</el-checkbox
            >
          </value-element>
        </help>
        ...
        <div v-show="data.particleSettings.useMotion">
          ...
          <div v-show="!data.useGravity">
            ...
            <select-value
              label="Distance Ease"
              v-model="data.particleSettings.distanceEase"
              :options="easingTypes"
            />
          </div>
          ...
          <div v-show="data.useGravity">
            ...
            <help
              text="Particle rotation will be aligned to movement direction"
            >
              <value-element>
                <el-checkbox v-model="data.particleSettings.align"
                  >Align To Movement Direction</el-checkbox
                >
              </value-element>
            </help>
            ...
            <div v-show="data.useFloor">
              <help
                v-show="!data.particleSettings.stopOnBounce"
                text="Factor applied to reversed y movement speed when particle hits floor"
              >
                <min-max-number-value
                  label="Bounce Fac"
                  :lower-limit="0"
              ...
              <help
                text="Factor applied to movement speed if particle hits floor"
              >
                <min-max-number-value
                  label="Friction"
                  :lower-limit="0"
              ...
              <help text="Particle will be removed when hitting the floor">
                <value-element>
                  <el-checkbox v-model="data.particleSettings.stopOnBounce"
                    >Stop On Bounce</el-checkbox
                  >
                </value-element>
              </help>
            </div>
      ...
      <value-group v-show="!data.particleSettings.align">
        <help text="Enable rotation settings">
          <value-element>
            <el-checkbox
              border
              size="small"
              v-model="data.particleSettings.useRotation"
              >Use Rotation</el-checkbox
            >
          </value-element>
        </help>
        ...
        <div v-show="data.particleSettings.useRotation">
          ...
          <help
            v-show="
              data.particleSettings.rotationSpeedMin > 0 ||
              data.particleSettings.rotationSpeedMax > 0
            "
            text="Randomize rotation direction"
          >
            <value-element>
              <el-checkbox
                v-model="data.particleSettings.randomRotationDirection"
                >Random Rotation Direction</el-checkbox
              >
            </value-element>
          </help>
          <help text="Randomize particle start rotation">
            <value-element>
              <el-checkbox v-model="data.particleSettings.randomStartRotation"
                >Random Start Rotation</el-checkbox
              >
            </value-element>
          </help>
        </div>
      ...
      <value-group>
        <help text="Enable alpha settings">
          <value-element>
            <el-checkbox
              border
              size="small"
              v-model="data.particleSettings.useAlpha"
              >Use Alpha</el-checkbox
            >
          </value-element>
        </help>
        ...
        <div v-show="data.particleSettings.useAlpha">
          ...
          <help text="Fade-in particle on start">
            <value-element>
              <el-checkbox v-model="data.particleSettings.fadeIn"
                >Fade-In</el-checkbox
              >
            </value-element>
          </help>
          ...
          <div v-show="data.particleSettings.fadeIn">
            <help text="Factor of particle life time used for fade-in">
              <number-value
                ...
                :upper-limit="1"
                :step="0.1"
                label="Fade-In Duration Factor"
                v-model="data.particleSettings.fadeInDurationFac"
              />
            </help>
            <help text="Easing equation used for fade-in">
              <select-value
                label="Fade-In Ease"
                v-model="data.particleSettings.fadeInEase"
                :options="easingTypes"
              />
            </help>
            <value-delimiter />
          ...
          <select-value
            label="Alpha Ease"
            v-model="data.particleSettings.alphaEase"
            :options="easingTypes"
          />
        </div>
      </value-group>
      ...
      <value-group>
        <help text="Enable scale settings">
          <value-element>
            <el-checkbox
              border
              size="small"
              v-model="data.particleSettings.useScale"
              >Use Scale</el-checkbox
            >
          </value-element>
        </help>
        ...
        <div v-show="data.particleSettings.useScale">
          ...
          <help text="Scale-In particle on start">
            <value-element>
              <el-checkbox v-model="data.particleSettings.scaleIn"
                >Scale-In</el-checkbox
              >
            </value-element>
          </help>
          ...
          <div v-show="data.particleSettings.scaleIn">
            <help text="Factor of particle life time used for scale-in">
              <number-value
                ...
                :upper-limit="1"
                :step="0.1"
                label="Scale-In Duration Factor"
                v-model="data.particleSettings.scaleInDurationFac"
              />
            </help>
            <help text="Easing equation used for scale-in">
              <select-value
                label="Scale-In Ease"
                v-model="data.particleSettings.scaleInEase"
                :options="easingTypes"
              />
            </help>
            <value-delimiter />
          ...
          <help text="Scale particle uniformly on x and y">
            <value-element>
              <el-checkbox v-model="data.particleSettings.uniformScale"
                >Uniform scale</el-checkbox
              >
            </value-element>
          </help>
          ...
          <div v-if="!data.particleSettings.uniformScale">
            ...
            <select-value
              label="Scale X Ease"
              v-model="data.particleSettings.scaleXEase"
              :options="easingTypes"
            />
            ...
            <select-value
              label="Scale Y Ease"
              v-model="data.particleSettings.scaleYEase"
              :options="easingTypes"
            />
          </div>
          ...
          <div v-if="data.particleSettings.uniformScale">
            ...
            <select-value
              label="Scale Ease"
              v-model="data.particleSettings.scaleEase"
              :options="easingTypes"
            />
          </div>
        </div>
      ...
      <value-group>
        <help text="Enable tint settings">
          <value-element>
            <el-checkbox
              border
              size="small"
              v-model="data.particleSettings.useTint"
              >Use Tint</el-checkbox
            >
          </value-element>
        </help>
        ...
        <div v-show="data.particleSettings.useTint">
          ...
          <el-row type="flex">
            <el-col>
              <help text="Particle start tint color">
                <color-value
                  label="Start Tint"
                  v-model="data.particleSettings.tintStart"
                />
              </help>
            </el-col>
            <el-col>
              <help text="Particle end tint color">
                <color-value
                  label="End Tint"
                  v-model="data.particleSettings.tintEnd"
                />
              </help>
            </el-col>
          </el-row>
          <select-value
            label="Tint Ease"
            v-model="data.particleSettings.tintEase"
            :options="easingTypes"
          />
        </div>
      </value-group>
        ...
        <help text="Enable child settings">
          <value-element>
            <el-checkbox
              border
              size="small"
              v-model="data.particleSettings.useChilds"
              >Use Childs</el-checkbox
            >
          </value-element>
        </help>
        ...
        <div v-show="data.particleSettings.useChilds">
          ...
          <value-element label="Childs">
            <child-list
              ...
              @remove="
                removeObjectFromList($event, data.particleSettings.childs)
              "
            />
          </value-element>
        </div>
      ...
      <value-group>
        <help text="Enable spawn events settings">
          <value-element>
            <el-checkbox
              border
              size="small"
              v-model="data.particleSettings.useSpawns"
              >Use Spawn Events</el-checkbox
            >
          </value-element>
        </help>
        ...
        <div v-show="data.particleSettings.useSpawns">
              ...
              <spawn-list
                ...
                @remove="
                  removeObjectFromList(
                    $event,
                    data.particleSettings.spawn.onStart,
                  )
                "
              />
            </value-element>
            ...
            <value-element label="Spawn On Bounce" v-if="data.useGravity">
              <spawn-list
                ...
                @remove="
                  removeObjectFromList(
                    $event,
                    data.particleSettings.spawn.onBounce,
                  )
                "
              />
            </value-element>
          ...
          <help
            text="Emitters/sequences to be spawned if particle reaches half of its life time"
          >
            <value-element label="Spawn On Mid">
              <spawn-list
                ...
                @remove="
                  removeObjectFromList(
                    $event,
                    data.particleSettings.spawn.onHalfway,
                  )
                "
              />
            </value-element>
            ...
            <value-element label="Spawn On Complete">
              <spawn-list
                ...
                @remove="
                  removeObjectFromList(
                    $event,
                    data.particleSettings.spawn.onComplete,
                  )
                "
              />
            </value-element>
...
import AngleDegreeValue from "./values/AngleDegreeValue.vue";
import MinMaxNumberValue from "./values/MinMaxNumberValue.vue";
import ColorValue from "./values/ColorValue.vue";
import ValueDelimiter from "./values/ValueDelimiter.vue";
import {
